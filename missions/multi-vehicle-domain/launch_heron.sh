...
#--------------------------------------------------------------
#  Part 3: Apply INDEX to port vals. If Heron, set vals by vname. 
#--------------------------------------------------------------
...
nsplug meta_heron.moos targs/targ_$VNAME.moos $NSFLAGS WARP=$TIME_WARP \
       ...
       REGION=$REGION               MISSION_NAME=$MISSION_NAME \
       COLOR=$COLOR

nsplug meta_heron.bhv targs/targ_$VNAME.bhv $NSFLAGS VNAME=$VNAME  \
       SPEED=$SPEED    ZONE=$ZONE \
       LOITER_SPD=$LOITER_SPD  CLOCKWISE=$CLOCK       \
       ENCIRC_POS=$ENCIRC_POS  ENCIRC_RAD=$ENCIRC_RAD
